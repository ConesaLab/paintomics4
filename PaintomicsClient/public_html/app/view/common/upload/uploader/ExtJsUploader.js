 ...
 * 
 */
Ext.define('Ext.upload.uploader.ExtJsUploader', {
    extend: 'Ext.upload.uploader.AbstractXhrUploader',
    requires: [
        'Ext.upload.data.Connection'
    ],
    config: {
        /**
     ...
     * 
     * @return {Ext.upload.data.Connection}
     */
    initConnection: function () {
        ...
        if (this.connection instanceof Ext.data.Connection) {
            ...
            conn = Ext.create('Ext.upload.data.Connection', {
                disableCaching: true,
                method: this.method,
                url: url,
    ...
    /**
     * Implements {@link Ext.upload.uploader.AbstractUploader#uploadItem}
     * 
    ...
    /**
     * Implements {@link Ext.upload.uploader.AbstractUploader#abortUpload}
     */
