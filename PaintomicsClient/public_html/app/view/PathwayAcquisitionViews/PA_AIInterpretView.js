...
function PA_AIInterpretView() {
    ...
    var TOOL_LABELS = {
        ...
        list_pathway_genes: "Listed a pathway's genes",
        get_gene_measurements: "Read gene measurements",
        make_figure: "Drew a figure",
        test_gene_set: "Tested a named gene set",
        differential_test: "Tested replicates for change",
        sample_ordination: "Projected the samples",
        compare_sets: "Compared feature lists",
